...
namespace ModStuff.UI
{
    public class UIFactory : Singleton<UIFactory>
    {
        ...
        {
            // TODO: Make this. It used ModMaster.TexturesPath to get path to textures folder, so couldn't include it right now
        ...
        {
            if (!(hover is UIButton) && !(hover is UIGFXButton) && !(hover is UICheckBox) && !(hover is UISlider) && !(hover is UIListExplorer)) return null;
